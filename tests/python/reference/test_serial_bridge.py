...
from tests.python._support import PROJECT_ROOT, REFERENCE_PYTHON_ROOT

from dmc2_reference.serial_bridge import (
...
BRIDGE = REFERENCE_PYTHON_ROOT / "dmc2_reference" / "serial_bridge.py"
