...
def validate_linuxcnc_interface_coverage() -> str:
    ...
    source_root = Path("/home/kit/linuxcnc-2.9.10-source")
    ...
    diagnostics = (monitor_root / "diagnostics.rs").read_text(encoding="utf-8")
    monitor = (monitor_root / "main.rs").read_text(encoding="utf-8")
    required_monitor_contract = (
        ...
        (monitor, "dmc2_task_status_poll(channel, &mut snapshot, &mut nml_error)"),
