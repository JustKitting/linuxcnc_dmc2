...
pub fn build(poly: &Polygon, samples: &[Sample], f: &Fitted, r: &Request) -> Result<Report, Error> {
    ...
    let mut csv_rows=String::from("cover_sample,source_triangle,model_x_mm,model_y_mm,model_z_mm,machine_x_mm,machine_y_mm,machine_z_mm,cover_radius_mm,signed_outside_distance_mm,clearance_lower_mm,clearance_upper_mm,clearance_deficit_lower_mm,clearance_deficit_upper_mm,nearest_outline_segment\n");
