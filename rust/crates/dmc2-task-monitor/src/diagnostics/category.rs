...
pub const CONTROLLER_FAULT: u64 = 1 << 22;
pub const SERIAL_BRIDGE_FAULT: u64 = 1 << 23;
pub const SPINDLE_FAULT: u64 = 1 << 24;
pub const SPINDLE_BLOCK: u64 = 1 << 25;
pub const DIAGNOSTIC_INTERFACE: u64 = 1 << 26;
